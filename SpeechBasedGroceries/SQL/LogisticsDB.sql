...
INSERT INTO t_delivery (f_del_customerno, f_del_date, f_del_street, f_del_zip, f_del_city, f_del_country, f_del_comment) VALUES
(2501,	'2020-03-22',	'Am Riemen 33',	'5000',	'Aarau',	'Schweiz',	'Tel. 079 123 45 67'),
(2503,	'2020-04-09',	'Bellevue 9a',	'9000',	'St. Gallen',	'Schweiz',	null),
(2503,	'2020-04-19',	'Bellevue 9a',	'9000',	'St. Gallen',	'Schweiz',	'Kann beim Nachbarn hinterlegt werden');

INSERT INTO t_position (f_del_id, f_pos_no, f_pos_itemid, f_pos_itemtext, f_pos_itemqty, f_pos_itemprice, f_pos_itemweight, f_pos_comment) VALUES
